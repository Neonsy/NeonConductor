...
`,
    ...
    {
        name: '002_app_composer_media_settings.sql',
        sql: `
...
`,
    ...
    {
        name: '003_provider_catalog_contract.sql',
        sql: `
...
`,
    ...
    {
        name: '004_provider_connection_profiles_and_api_family.sql',
        sql: `
ALTER TABLE provider_model_catalog
...
`,
    ...
    {
        name: '005_kilo_routed_api_family.sql',
        sql: `
ALTER TABLE provider_model_catalog
...
`,
    ...
    {
        name: '006_direct_anthropic_tool_protocol.sql',
        sql: `
...
`,
    ...
    {
        name: '007_direct_gemini_tool_protocol.sql',
        sql: `
ALTER TABLE provider_model_catalog RENAME TO provider_model_catalog_old;
...
`,
    ...
    {
        name: '008_runtime_transport_families.sql',
        sql: `
-- No-op migration.
