...
CREATE TABLE permissions (
    ...
    consumed_at TEXT NULL,
    rationale TEXT NULL,
    flow_instance_id TEXT NULL REFERENCES flow_instances(id) ON DELETE SET NULL,
    flow_step_index INTEGER NULL CHECK (flow_step_index IS NULL OR flow_step_index >= 0),
    flow_step_id TEXT NULL,
