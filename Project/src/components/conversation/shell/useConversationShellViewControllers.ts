...
export function useConversationShellViewControllers(input: UseConversationShellViewControllersInput) {
    ...
    const planOrchestrator = buildConversationPlanOrchestrator({
        ...
        planStartResearchBatchMutation: mutations.planStartResearchBatchMutation,
        planReviseMutation: mutations.planReviseMutation,
        planExpandNextPhaseMutation: mutations.planExpandNextPhaseMutation,
        planRevisePhaseMutation: mutations.planRevisePhaseMutation,
        ...
        planAbortResearchBatchMutation: mutations.planAbortResearchBatchMutation,
